...
#          record_unknown_question) and ensure notification logic works.
#
# How to Run:
...
from app.tools import record_user_details, record_unknown_question

if __name__ == "__main__":
    print(record_user_details("alice@example.com", name="Alice", notes="Interested in beta access"))
    print(record_unknown_question("Can Girma relocate to Germany?"))
